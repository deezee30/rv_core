...
public class Vector3D implements Cloneable, Serializable, ConfigurationSerializable, JSONAware {
	 ...
	 * @return the same vector
	 */
	public Vector3D subtract(double scalar) {
		x -= scalar;
		y -= scalar;
		z -= scalar;
		return this;
	...
	public static Vector3D get2DCentroid(Vector3D... vectors) {
	...
	public static Vector3D get2DCentroid(int y, Vector3D... vectors) {
		double centroidX = 0, centroidZ = 0;
	...
	public static Vector3D get3DCentroid(Vector3D... vectors) {
	...
	public static Vector3D deserialize(Map<String, Object> data) {
		return new Vector3D(
				(double) data.get("x"),
				(double) data.get("y"),
				(double) data.get("z")
